...
^f::exec_wheel_of_fortune(swo, swo, e_c)     ; Kill Portion Of Enemies	    Ctrl+E
^e::exec_wheel_of_fortune(swo, swo, swo)     ; Damage All Enemies	        Ctrl+F
^h::exec_wheel_of_fortune(pot, pot, pot)     ; Heal All Allies              Ctrl+H
^d::exec_wheel_of_fortune(gob, gob, e_c)     ; Debuff Enemies	            Ctrl+D
^b::exec_wheel_of_fortune(e_c, e_c, e_c)     ; Buff Players	                Ctrl+B
...
combinations
^::exec_wheel_of_fortune(gob, gob, gob)     ; Golden Enemies                Ctrl+
